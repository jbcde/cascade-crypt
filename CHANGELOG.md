...
### Compatibility
- **No wire format changes.** All files encrypted by any prior version decrypt under v0.7.3. No legitimate file's Argon2 params, chunk count, header line length, or keyfile size approaches the new caps.
